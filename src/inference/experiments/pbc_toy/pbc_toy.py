...
Usage:
    .venv\\Scripts\\python.exe src/inference/experiments/pbc_toy/pbc_toy.py
    .venv\\Scripts\\python.exe src/inference/experiments/pbc_toy/pbc_toy.py --checkpoint <path>
"""
import argparse
import sys
...
# -- constants ----------------------------------------------------------------
DEFAULT_CKPT = Path("src/models/weights/model9_n100_p050.pt")
DEFAULT_CFG  = Path("src/configs/training/model/model_config_9_n100_p050.yaml")
RD           = 0.076
...
def main():
    ...
    out = Path("artifacts/inference/experiments/pbc_toy/pbc_toy_result.png")
    plt.tight_layout()
