...
class ObstructionExperimentConfig:
    corrector_config: str = 'src/configs/experiments/obstruction/grid_6x6.yaml'
    rd:          float     = 0.012
    domain:      float     = 1.0
    cx:          float     = 0.5
    cy:          float     = 0.5
...
class ObstructionExperiment(Experiment):
    ...
    def _plot(self, m1, m2, n_real) -> None:
        ...
        out = Path('artifacts/inference/experiments/obstruction/runs') / 'obstruction_experiment.png'
